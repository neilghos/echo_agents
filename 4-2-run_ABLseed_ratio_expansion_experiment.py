...
#    for seed_ratio in list(range(1,5))+list(range(5,31,5))+list(range(40,101,10)):
#        main_runner(datasets,list(range(10)),ECD_models,score_methods, expansion_methods, suffixes, pre_path_results, pre_path_data, seed_ratio = seed_ratio/100)

#    datasets = [f'SBM_{N}' for N in [5,10,50,100]][3:]
    datasets = ["facebook","lastfm","git","twitter"][3:] 
    seed_ratios = [i/100 for i in list(range(1,31))]
